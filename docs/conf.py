# -*- coding: utf-8 -*-
#
# BongoMagic documentation build configuration file, created by
# sphinx-quickstart on Thu Aug 19 19:46:40 2010.
#
...
project = u'Electronic transaction system'
copyright = u'2011, EPIC'
...
latex_documents = [
  ('index', 'ets.tex', u'ETS Documentation',
   u'EPIC', 'manual'),
]
...
pdf_documents = [ ('index', u'ETS', u'ETS', u'EPIC'),
]
...
# overflow, shrink or truncate #pdf_fit_mode = "shrink"
...
# Name of the cover page template to use #pdf_cover_template = 'sphinxcover.tmpl'
...
# Set the default DPI for images #pdf_default_dpi = 72
# Enable rst2pdf extension modules (default is empty list) # you need vectorpdf for better sphinx's graphviz support #pdf_extensions = ['vectorpdf']
# Page template name for "regular" pages #pdf_page_template = 'cutePage'
