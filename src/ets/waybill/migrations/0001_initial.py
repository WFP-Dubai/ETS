...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('waybill', ['Places'])

        # Adding model 'WaybillAuditLogEntry'
        db.create_table('waybill_waybillauditlogentry', (
            ...
            ('destinationWarehouse', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['waybill.Places'], blank=True)),
        ...
        db.send_create_signal('waybill', ['WaybillAuditLogEntry'])

        # Adding model 'Waybill'
        db.create_table('waybill_waybill', (
        ...
        db.send_create_signal('waybill', ['Waybill'])
        ...
        db.send_create_signal('waybill', ['LtiOriginal'])

        # Adding model 'RemovedLtis'
        db.create_table(u'waybill_removed_ltis', (
            ('lti', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['waybill.LtiOriginal'], primary_key=True)),
        ))
        db.send_create_signal('waybill', ['RemovedLtis'])
        ...
        db.send_create_signal('waybill', ['EpicPerson'])
        ...
        db.send_create_signal('waybill', ['EpicStock'])
        ...
        db.send_create_signal('waybill', ['EpicLossDamages'])

        # Adding model 'LtiWithStock'
        db.create_table('waybill_ltiwithstock', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('lti_line', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['waybill.LtiOriginal'])),
            ('stock_item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['waybill.EpicStock'])),
            ('lti_code', self.gf('django.db.models.fields.CharField')(max_length=20, db_index=True)),
        ))
        db.send_create_signal('waybill', ['LtiWithStock'])

        # Adding model 'LoadingDetailAuditLogEntry'
        db.create_table('waybill_loadingdetailauditlogentry', (
            ('id', self.gf('django.db.models.fields.IntegerField')(db_index=True, blank=True)),
            ('wbNumber', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['waybill.Waybill'])),
            ('order_item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['waybill.LtiWithStock'])),
            ...
            ('unitsLostReason', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='_auditlog_LD_LostReason', null=True, to=orm['waybill.EpicLossDamages'])),
            ('unitsDamagedReason', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='_auditlog_LD_DamagedReason', null=True, to=orm['waybill.EpicLossDamages'])),
            ('unitsDamagedType', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='_auditlog_LD_DamagedType', null=True, to=orm['waybill.EpicLossDamages'])),
            ('unitsLostType', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='_auditlog_LD_LossType', null=True, to=orm['waybill.EpicLossDamages'])),
        ...
        db.send_create_signal('waybill', ['LoadingDetailAuditLogEntry'])

        # Adding model 'LoadingDetail'
        db.create_table('waybill_loadingdetail', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('wbNumber', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['waybill.Waybill'])),
            ('order_item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['waybill.LtiWithStock'])),
            ('numberUnitsLoaded', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=3)),
            ...
            ('numberUnitsLost', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=10, decimal_places=3, blank=True)),
            ('numberUnitsDamaged', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=10, decimal_places=3, blank=True)),
            ('unitsLostReason', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='LD_LostReason', null=True, to=orm['waybill.EpicLossDamages'])),
            ('unitsDamagedReason', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='LD_DamagedReason', null=True, to=orm['waybill.EpicLossDamages'])),
            ('unitsDamagedType', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='LD_DamagedType', null=True, to=orm['waybill.EpicLossDamages'])),
            ('unitsLostType', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='LD_LossType', null=True, to=orm['waybill.EpicLossDamages'])),
            ('overloadedUnits', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('loadingDetailSentToCompas', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('overOffloadUnits', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('waybill', ['LoadingDetail'])

        # Adding model 'DispatchPoint'
        db.create_table('waybill_dispatchpoint', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('waybill', ['DispatchPoint'])

        # Adding model 'ReceptionPoint'
        db.create_table('waybill_receptionpoint', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('waybill', ['ReceptionPoint'])

        # Adding model 'UserProfileAuditLogEntry'
        db.create_table('waybill_userprofileauditlogentry', (
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('warehouses', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['waybill.DispatchPoint'], null=True, blank=True)),
            ('receptionPoints', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['waybill.ReceptionPoint'], null=True, blank=True)),
            ...
            ('compasUser', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['waybill.EpicPerson'], null=True, blank=True)),
        ...
        db.send_create_signal('waybill', ['UserProfileAuditLogEntry'])

        # Adding model 'UserProfile'
        db.create_table('waybill_userprofile', (
        ...
        db.send_create_signal('waybill', ['UserProfile'])

        # Adding model 'SiTracker'
        db.create_table('waybill_sitracker', (
            ('LTI', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['waybill.LtiOriginal'], unique=True, primary_key=True)),
        ...
        db.send_create_signal('waybill', ['SiTracker'])

        # Adding model 'PackagingDescriptionShort'
        db.create_table('waybill_packagingdescriptionshort', (
        ...
        db.send_create_signal('waybill', ['PackagingDescriptionShort'])
        ...
        db.create_table(u'loggercompas', (
            ...
            ('wb', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['waybill.Waybill'], primary_key=True)),
        ...
        db.send_create_signal('waybill', ['CompasLogger'])
        ...
        db.send_create_signal('waybill', ['DispatchMaster'])

        # Adding model 'DispatchDetail'
        db.create_table(u'dispatch_details', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('code', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['waybill.DispatchMaster'])),
            ('document_code', self.gf('django.db.models.fields.CharField')(max_length=2)),
        ...
        db.send_create_signal('waybill', ['DispatchDetail'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('waybill_waybillauditlogentry')

        # Deleting model 'Waybill'
        db.delete_table('waybill_waybill')
        ...
        db.delete_table('waybill_ltiwithstock')

        # Deleting model 'LoadingDetailAuditLogEntry'
        db.delete_table('waybill_loadingdetailauditlogentry')

        # Deleting model 'LoadingDetail'
        db.delete_table('waybill_loadingdetail')

        # Deleting model 'DispatchPoint'
        db.delete_table('waybill_dispatchpoint')

        # Deleting model 'ReceptionPoint'
        db.delete_table('waybill_receptionpoint')

        # Deleting model 'UserProfileAuditLogEntry'
        db.delete_table('waybill_userprofileauditlogentry')

        # Deleting model 'UserProfile'
        db.delete_table('waybill_userprofile')

        # Deleting model 'SiTracker'
        db.delete_table('waybill_sitracker')

        # Deleting model 'PackagingDescriptionShort'
        db.delete_table('waybill_packagingdescriptionshort')
    ...
    models = {
        ...
        'waybill.compaslogger': {
            ...
            'wb': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['waybill.Waybill']", 'primary_key': 'True'})
        },
        'waybill.dispatchdetail': {
            ...
            'code': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['waybill.DispatchMaster']"}),
        ...
        'waybill.loadingdetail': {
            ...
            'order_item': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['waybill.LtiWithStock']"}),
            ...
            'unitsDamagedReason': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'LD_DamagedReason'", 'null': 'True', 'to': "orm['waybill.EpicLossDamages']"}),
            'unitsDamagedType': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'LD_DamagedType'", 'null': 'True', 'to': "orm['waybill.EpicLossDamages']"}),
            'unitsLostReason': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'LD_LostReason'", 'null': 'True', 'to': "orm['waybill.EpicLossDamages']"}),
            'unitsLostType': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'LD_LossType'", 'null': 'True', 'to': "orm['waybill.EpicLossDamages']"}),
            'wbNumber': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['waybill.Waybill']"})
        },
        'waybill.loadingdetailauditlogentry': {
            ...
            'overOffloadUnits': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'overloadedUnits': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'unitsDamagedReason': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'_auditlog_LD_DamagedReason'", 'null': 'True', 'to': "orm['waybill.EpicLossDamages']"}),
            'unitsDamagedType': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'_auditlog_LD_DamagedType'", 'null': 'True', 'to': "orm['waybill.EpicLossDamages']"}),
            'unitsLostReason': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'_auditlog_LD_LostReason'", 'null': 'True', 'to': "orm['waybill.EpicLossDamages']"}),
            'unitsLostType': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'_auditlog_LD_LossType'", 'null': 'True', 'to': "orm['waybill.EpicLossDamages']"}),
            'wbNumber': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['waybill.Waybill']"})
        },
        'waybill.ltioriginal': {
        ...
        'waybill.ltiwithstock': {
            'Meta': {'object_name': 'LtiWithStock'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lti_code': ('django.db.models.fields.CharField', [], {'max_length': '20', 'db_index': 'True'}),
            'lti_line': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['waybill.LtiOriginal']"}),
            'stock_item': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['waybill.EpicStock']"})
        },
        'waybill.packagingdescriptionshort': {
        ...
        'waybill.removedltis': {
            ...
            'lti': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['waybill.LtiOriginal']", 'primary_key': 'True'})
        },
        'waybill.sitracker': {
            'LTI': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['waybill.LtiOriginal']", 'unique': 'True', 'primary_key': 'True'}),
        ...
        'waybill.userprofile': {
            ...
            'compasUser': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['waybill.EpicPerson']", 'null': 'True', 'blank': 'True'}),
            ...
            'receptionPoints': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['waybill.ReceptionPoint']", 'null': 'True', 'blank': 'True'}),
            ...
            'warehouses': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['waybill.DispatchPoint']", 'null': 'True', 'blank': 'True'})
        },
        'waybill.userprofileauditlogentry': {
        ...
        'waybill.waybill': {
            ...
            'destinationWarehouse': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['waybill.Places']", 'blank': 'True'}),
