...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Compas.db_engine'
        db.delete_column('ets_compas', 'db_engine')


    def backwards(self, orm):
        
        # Adding field 'Compas.db_engine'
        db.add_column('ets_compas', 'db_engine', self.gf('django.db.models.fields.CharField')(default='django.db.backends.oracle', max_length=100), keep_default=False)
