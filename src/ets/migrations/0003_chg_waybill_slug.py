...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('ets_waybill', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=('date_removed',), max_length=50, primary_key=True, unique=False, populate_from=None, db_index=True))


    def backwards(self, orm):
        
        # Changing field 'OrderItem.number_of_units'
        db.alter_column('ets_waybill', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=(), max_length=50, primary_key=True, unique=True, populate_from=None, db_index=True))
    ...
    models = {
        ...
        'ets.waybill': {
            ...
            'sent_compas': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'slug': ('autoslug.fields.AutoSlugField', [], {'unique_with': '("date_removed",)', 'max_length': '50', 'primary_key': 'True', 'unique': 'False', 'populate_from': 'None', 'db_index': 'True'}),
