...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LoadingDetail.received_net_lost'
        db.add_column('ets_loadingdetail', 'received_net_lost', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=3), keep_default=False)

        # Adding field 'LoadingDetail.received_net_damaged'
        db.add_column('ets_loadingdetail', 'received_net_damaged', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=3), keep_default=False)

        # Adding field 'LoadingDetail.received_gross_lost'
        db.add_column('ets_loadingdetail', 'received_gross_lost', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=3), keep_default=False)

        # Adding field 'LoadingDetail.received_gross_damaged'
        db.add_column('ets_loadingdetail', 'received_gross_damaged', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=3), keep_default=False)

        # Adding field 'Waybill.receipt_warehouse'
        db.add_column('ets_waybill', 'receipt_warehouse', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='receipt_waybills2', null=True, to=orm['ets.Warehouse']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LoadingDetail.received_net_lost'
        db.delete_column('ets_loadingdetail', 'received_net_lost')

        # Deleting field 'LoadingDetail.received_net_damaged'
        db.delete_column('ets_loadingdetail', 'received_net_damaged')

        # Deleting field 'LoadingDetail.received_gross_lost'
        db.delete_column('ets_loadingdetail', 'received_gross_lost')

        # Deleting field 'LoadingDetail.received_gross_damaged'
        db.delete_column('ets_loadingdetail', 'received_gross_damaged')

        # Deleting field 'Waybill.receipt_warehouse'
        db.delete_column('ets_waybill', 'receipt_warehouse_id')
    ...
    models = {
        ...
        'ets.loadingdetail': {
            ...
            'received_gross_damaged': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '12', 'decimal_places': '3'}),
            'received_gross_lost': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '12', 'decimal_places': '3'}),
            'received_net_damaged': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '12', 'decimal_places': '3'}),
            'received_net_lost': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '12', 'decimal_places': '3'}),
            ...
            'total_weight_gross': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '12', 'decimal_places': '5'}),
            'total_weight_gross_received': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '12', 'decimal_places': '3'}),
            'total_weight_net': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '12', 'decimal_places': '5'}),
        ...
        'ets.waybill': {
            ...
            'receipt_warehouse': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'receipt_waybills2'", 'null': 'True', 'to': "orm['ets.Warehouse']"}),
