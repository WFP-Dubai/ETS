...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OrderItem.lti_id'
        db.alter_column('ets_orderitem', 'lti_id', self.gf('django.db.models.fields.CharField')(default=1, max_length=40))


    def backwards(self, orm):
        
        # Changing field 'OrderItem.lti_id'
        db.alter_column('ets_orderitem', 'lti_id', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))
