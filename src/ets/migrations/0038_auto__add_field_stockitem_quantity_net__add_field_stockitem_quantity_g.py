...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('ets_stockitem', 'quantity_net', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=3), keep_default=False)

        # Adding field 'StockItem.quantity_gross'
        db.add_column('ets_stockitem', 'quantity_gross', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=3), keep_default=False)
