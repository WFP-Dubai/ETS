...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Compas.code'
        db.alter_column('ets_compas', 'code', self.gf('django.db.models.fields.CharField')(max_length=20, primary_key=True))


    def backwards(self, orm):
        
        # Changing field 'Compas.code'
        db.alter_column('ets_compas', 'code', self.gf('django.db.models.fields.CharField')(max_length=7, primary_key=True))
