...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OrderItem.lti_id'
        db.add_column('ets_orderitem', 'lti_id', self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OrderItem.lti_id'
        db.delete_column('ets_orderitem', 'lti_id')
