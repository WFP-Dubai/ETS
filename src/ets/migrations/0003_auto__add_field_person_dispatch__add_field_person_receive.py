...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Person.dispatch'
        db.add_column('ets_person', 'dispatch', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'Person.receive'
        db.add_column('ets_person', 'receive', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Person.dispatch'
        db.delete_column('ets_person', 'dispatch')

        # Deleting field 'Person.receive'
        db.delete_column('ets_person', 'receive')
    ...
    models = {
        ...
        'ets.person': {
            ...
            'dispatch': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            'receive': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
