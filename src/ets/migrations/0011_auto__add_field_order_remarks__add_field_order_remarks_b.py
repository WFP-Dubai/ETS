...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Order.remarks'
        db.add_column('ets_order', 'remarks', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Order.remarks_b'
        db.add_column('ets_order', 'remarks_b', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Order.remarks'
        db.delete_column('ets_order', 'remarks')

        # Deleting field 'Order.remarks_b'
        db.delete_column('ets_order', 'remarks_b')
