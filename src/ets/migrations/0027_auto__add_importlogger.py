...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ImportLogger'
        db.create_table('ets_importlogger', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('compas', self.gf('django.db.models.fields.related.ForeignKey')(related_name='import_logs', to=orm['ets.Compas'])),
            ('when_attempted', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('status', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('message', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('ets', ['ImportLogger'])


    def backwards(self, orm):
        
        # Deleting model 'ImportLogger'
        db.delete_table('ets_importlogger')
