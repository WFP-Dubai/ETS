...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Order.project_number'
        db.delete_column('ets_order', 'project_number')


    def backwards(self, orm):
        
        # Adding field 'Order.project_number'
        db.add_column('ets_order', 'project_number', self.gf('django.db.models.fields.CharField')(default='', max_length=24, blank=True), keep_default=False)
