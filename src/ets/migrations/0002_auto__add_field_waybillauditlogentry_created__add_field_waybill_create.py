...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WaybillAuditLogEntry.created'
        db.add_column('ets_waybillauditlogentry', 'created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)

        # Adding field 'Waybill.created'
        db.add_column('ets_waybill', 'created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WaybillAuditLogEntry.created'
        db.delete_column('ets_waybillauditlogentry', 'created')

        # Deleting field 'Waybill.created'
        db.delete_column('ets_waybill', 'created')
