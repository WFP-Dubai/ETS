...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('ets_location', 'country', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Location.country'
        raise RuntimeError("Cannot reverse this migration. 'Location.country' and its values cannot be restored.")
