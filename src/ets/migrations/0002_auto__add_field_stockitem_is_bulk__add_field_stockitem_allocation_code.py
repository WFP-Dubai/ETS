...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StockItem.is_bulk'
        db.add_column('ets_stockitem', 'is_bulk', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'StockItem.allocation_code'
        db.add_column('ets_stockitem', 'allocation_code', self.gf('django.db.models.fields.CharField')(default=1, max_length=10), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'StockItem.is_bulk'
        db.delete_column('ets_stockitem', 'is_bulk')

        # Deleting field 'StockItem.allocation_code'
        db.delete_column('ets_stockitem', 'allocation_code')
