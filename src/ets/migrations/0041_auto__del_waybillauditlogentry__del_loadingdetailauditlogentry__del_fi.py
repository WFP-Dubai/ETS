...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('ets_waybillauditlogentry', (
            ...
            ('slug', self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique_with=(), populate_from=None)),
            ...
            ('receipt_person', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_auditlog_recipient_waybills', null=True, to=orm['ets.Person'], blank=True)),
            ('barcode', self.gf('sorl.thumbnail.fields.ImageField')(max_length=255, null=True, blank=True)),
        ...
        db.create_table('ets_loadingdetailauditlogentry', (
            ('total_weight_gross', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=5)),
            ('_order', self.gf('django.db.models.fields.proxy.OrderWrt')()),
            ...
            ('total_weight_gross_received', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=3)),
            ('stock_item', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_auditlog_dispatches', to=orm['ets.StockItem'])),
            ('slug', self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique_with=(), populate_from=None)),
            ('number_units_damaged', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=3)),
            ('units_damaged_reason', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_auditlog_damage_reason', null=True, to=orm['ets.LossDamageType'], blank=True)),
            ...
            ('total_weight_net_received', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=3)),
            ...
            ('units_lost_reason', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_auditlog_lost_reason', null=True, to=orm['ets.LossDamageType'], blank=True)),
            ('total_weight_net', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=5)),
            ('number_units_good', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=3)),
            ('unit_weight_net', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=3)),
            ('action_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('number_units_lost', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=3)),
            ('action_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
