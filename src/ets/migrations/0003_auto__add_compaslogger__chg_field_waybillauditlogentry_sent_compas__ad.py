...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WaybillAuditLogEntry.sent_compas'
        db.alter_column('ets_waybillauditlogentry', 'sent_compas', self.gf('django.db.models.fields.DateTimeField')(null=True))
        ...
        # Changing field 'Waybill.sent_compas'
        db.alter_column('ets_waybill', 'sent_compas', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'ReceiptWaybill.sent_compas'
        db.alter_column('ets_receiptwaybill', 'sent_compas', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'WaybillAuditLogEntry.sent_compas'
        db.alter_column('ets_waybillauditlogentry', 'sent_compas', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Waybill.sent_compas'
        db.alter_column('ets_waybill', 'sent_compas', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'ReceiptWaybill.sent_compas'
        db.alter_column('ets_receiptwaybill', 'sent_compas', self.gf('django.db.models.fields.BooleanField')())
