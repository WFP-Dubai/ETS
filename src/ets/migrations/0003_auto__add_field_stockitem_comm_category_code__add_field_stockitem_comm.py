...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StockItem.comm_category_code'
        db.add_column('ets_stockitem', 'comm_category_code', self.gf('django.db.models.fields.CharField')(default='code', max_length=9), keep_default=False)

        # Adding field 'StockItem.commodity_name'
        db.add_column('ets_stockitem', 'commodity_name', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'StockItem.comm_category_code'
        db.delete_column('ets_stockitem', 'comm_category_code')

        # Deleting field 'StockItem.commodity_name'
        db.delete_column('ets_stockitem', 'commodity_name')
