...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Warehouse.end_date'
        db.add_column('ets_warehouse', 'end_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Warehouse.end_date'
        db.delete_column('ets_warehouse', 'end_date')
