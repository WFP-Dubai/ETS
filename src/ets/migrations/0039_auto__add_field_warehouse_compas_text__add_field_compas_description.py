...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Warehouse.compas_text'
        db.add_column('ets_warehouse', 'compas_text', self.gf('django.db.models.fields.CharField')(max_length=13, null=True, blank=True), keep_default=False)

        # Adding field 'Compas.description'
        db.add_column('ets_compas', 'description', self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Warehouse.compas_text'
        db.delete_column('ets_warehouse', 'compas_text')

        # Deleting field 'Compas.description'
        db.delete_column('ets_compas', 'description')
