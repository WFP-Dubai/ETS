...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ReceiptWaybill.container_one_remarks_reciept'
        db.add_column('ets_receiptwaybill', 'container_one_remarks_reciept', self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True), keep_default=False)

        # Adding field 'ReceiptWaybill.container_two_remarks_reciept'
        db.add_column('ets_receiptwaybill', 'container_two_remarks_reciept', self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True), keep_default=False)

        # Deleting field 'WaybillAuditLogEntry.container_one_remarks_reciept'
        db.delete_column('ets_waybillauditlogentry', 'container_one_remarks_reciept')

        # Deleting field 'WaybillAuditLogEntry.container_two_remarks_reciept'
        db.delete_column('ets_waybillauditlogentry', 'container_two_remarks_reciept')

        # Deleting field 'Waybill.container_one_remarks_reciept'
        db.delete_column('ets_waybill', 'container_one_remarks_reciept')

        # Deleting field 'Waybill.container_two_remarks_reciept'
        db.delete_column('ets_waybill', 'container_two_remarks_reciept')


    def backwards(self, orm):
        
        # Deleting field 'ReceiptWaybill.container_one_remarks_reciept'
        db.delete_column('ets_receiptwaybill', 'container_one_remarks_reciept')

        # Deleting field 'ReceiptWaybill.container_two_remarks_reciept'
        db.delete_column('ets_receiptwaybill', 'container_two_remarks_reciept')

        # Adding field 'WaybillAuditLogEntry.container_one_remarks_reciept'
        db.add_column('ets_waybillauditlogentry', 'container_one_remarks_reciept', self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True), keep_default=False)

        # Adding field 'WaybillAuditLogEntry.container_two_remarks_reciept'
        db.add_column('ets_waybillauditlogentry', 'container_two_remarks_reciept', self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True), keep_default=False)

        # Adding field 'Waybill.container_one_remarks_reciept'
        db.add_column('ets_waybill', 'container_one_remarks_reciept', self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True), keep_default=False)

        # Adding field 'Waybill.container_two_remarks_reciept'
        db.add_column('ets_waybill', 'container_two_remarks_reciept', self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True), keep_default=False)
