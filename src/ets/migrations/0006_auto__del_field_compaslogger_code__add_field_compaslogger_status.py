...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CompasLogger.code'
        db.delete_column('ets_compaslogger', 'code')

        # Adding field 'CompasLogger.status'
        db.add_column('ets_compaslogger', 'status', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'CompasLogger.code'
        raise RuntimeError("Cannot reverse this migration. 'CompasLogger.code' and its values cannot be restored.")

        # Deleting field 'CompasLogger.status'
        db.delete_column('ets_compaslogger', 'status')
