...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LoadingDetail.unit_weight_net'
        db.add_column('ets_loadingdetail', 'unit_weight_net', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=3, blank=True), keep_default=False)

        # Adding field 'LoadingDetail.unit_weight_gross'
        db.add_column('ets_loadingdetail', 'unit_weight_gross', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=3, blank=True), keep_default=False)

        # Adding field 'LoadingDetail.total_weight_net'
        db.add_column('ets_loadingdetail', 'total_weight_net', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=3, blank=True), keep_default=False)

        # Adding field 'LoadingDetail.total_weight_gross'
        db.add_column('ets_loadingdetail', 'total_weight_gross', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=3, blank=True), keep_default=False)

        # Adding field 'LoadingDetailAuditLogEntry.unit_weight_net'
        db.add_column('ets_loadingdetailauditlogentry', 'unit_weight_net', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=3, blank=True), keep_default=False)

        # Adding field 'LoadingDetailAuditLogEntry.unit_weight_gross'
        db.add_column('ets_loadingdetailauditlogentry', 'unit_weight_gross', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=3, blank=True), keep_default=False)

        # Adding field 'LoadingDetailAuditLogEntry.total_weight_net'
        db.add_column('ets_loadingdetailauditlogentry', 'total_weight_net', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=3, blank=True), keep_default=False)

        # Adding field 'LoadingDetailAuditLogEntry.total_weight_gross'
        db.add_column('ets_loadingdetailauditlogentry', 'total_weight_gross', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=3, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LoadingDetail.unit_weight_net'
        db.delete_column('ets_loadingdetail', 'unit_weight_net')

        # Deleting field 'LoadingDetail.unit_weight_gross'
        db.delete_column('ets_loadingdetail', 'unit_weight_gross')

        # Deleting field 'LoadingDetail.total_weight_net'
        db.delete_column('ets_loadingdetail', 'total_weight_net')

        # Deleting field 'LoadingDetail.total_weight_gross'
        db.delete_column('ets_loadingdetail', 'total_weight_gross')

        # Deleting field 'LoadingDetailAuditLogEntry.unit_weight_net'
        db.delete_column('ets_loadingdetailauditlogentry', 'unit_weight_net')

        # Deleting field 'LoadingDetailAuditLogEntry.unit_weight_gross'
        db.delete_column('ets_loadingdetailauditlogentry', 'unit_weight_gross')

        # Deleting field 'LoadingDetailAuditLogEntry.total_weight_net'
        db.delete_column('ets_loadingdetailauditlogentry', 'total_weight_net')

        # Deleting field 'LoadingDetailAuditLogEntry.total_weight_gross'
        db.delete_column('ets_loadingdetailauditlogentry', 'total_weight_gross')
