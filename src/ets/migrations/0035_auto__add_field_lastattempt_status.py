...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LastAttempt.status'
        db.add_column('ets_lastattempt', 'status', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LastAttempt.status'
        db.delete_column('ets_lastattempt', 'status')
