...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Waybill', fields ['receipt_signed_date']
        db.create_index('ets_waybill', ['receipt_signed_date'])

        # Adding index on 'Waybill', fields ['dispatch_date']
        db.create_index('ets_waybill', ['dispatch_date'])

        # Adding index on 'Waybill', fields ['transport_dispach_signed_date']
        db.create_index('ets_waybill', ['transport_dispach_signed_date'])

        # Adding index on 'Waybill', fields ['validated']
        db.create_index('ets_waybill', ['validated'])

        # Adding index on 'Waybill', fields ['loading_date']
        db.create_index('ets_waybill', ['loading_date'])

        # Adding index on 'Waybill', fields ['receipt_validated']
        db.create_index('ets_waybill', ['receipt_validated'])

        # Adding index on 'Waybill', fields ['receipt_sent_compas']
        db.create_index('ets_waybill', ['receipt_sent_compas'])

        # Adding index on 'Waybill', fields ['sent_compas']
        db.create_index('ets_waybill', ['sent_compas'])


    def backwards(self, orm):
        # Removing index on 'Waybill', fields ['sent_compas']
        db.delete_index('ets_waybill', ['sent_compas'])

        # Removing index on 'Waybill', fields ['receipt_sent_compas']
        db.delete_index('ets_waybill', ['receipt_sent_compas'])

        # Removing index on 'Waybill', fields ['receipt_validated']
        db.delete_index('ets_waybill', ['receipt_validated'])

        # Removing index on 'Waybill', fields ['loading_date']
        db.delete_index('ets_waybill', ['loading_date'])

        # Removing index on 'Waybill', fields ['validated']
        db.delete_index('ets_waybill', ['validated'])

        # Removing index on 'Waybill', fields ['transport_dispach_signed_date']
        db.delete_index('ets_waybill', ['transport_dispach_signed_date'])

        # Removing index on 'Waybill', fields ['dispatch_date']
        db.delete_index('ets_waybill', ['dispatch_date'])

        # Removing index on 'Waybill', fields ['receipt_signed_date']
        db.delete_index('ets_waybill', ['receipt_signed_date'])
