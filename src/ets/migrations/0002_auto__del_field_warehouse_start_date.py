...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Warehouse.start_date'
        db.delete_column('ets_warehouse', 'start_date')


    def backwards(self, orm):
        
        # Adding field 'Warehouse.start_date'
        db.add_column('ets_warehouse', 'start_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)
