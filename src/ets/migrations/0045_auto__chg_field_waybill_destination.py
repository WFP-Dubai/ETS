...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Waybill.destination'
        db.alter_column('ets_waybill', 'destination_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['ets.Warehouse']))
    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Waybill.destination'
        raise RuntimeError("Cannot reverse this migration. 'Waybill.destination' and its values cannot be restored.")
    models = {
        'auth.group': {
