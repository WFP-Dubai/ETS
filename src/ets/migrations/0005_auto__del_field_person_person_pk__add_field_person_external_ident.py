...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Person.person_pk'
        db.delete_column('ets_person', 'person_pk')

        # Adding field 'Person.external_ident'
        db.add_column('ets_person', 'external_ident', self.gf('django.db.models.fields.CharField')(default=1, max_length=20, primary_key=True), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Person.person_pk'
        raise RuntimeError("Cannot reverse this migration. 'Person.person_pk' and its values cannot be restored.")

        # Deleting field 'Person.external_ident'
        db.delete_column('ets_person', 'external_ident')
