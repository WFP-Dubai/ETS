...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'LastAttempt'
        db.create_table('ets_lastattempt', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('compas', self.gf('django.db.models.fields.related.OneToOneField')(related_name='last_attempt', unique=True, to=orm['ets.Compas'])),
            ('attempt_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal('ets', ['LastAttempt'])


    def backwards(self, orm):
        
        # Deleting model 'LastAttempt'
        db.delete_table('ets_lastattempt')
