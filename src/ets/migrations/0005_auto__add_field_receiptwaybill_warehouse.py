...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ReceiptWaybill.warehouse'
        db.add_column('ets_receiptwaybill', 'warehouse', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='receipts', to=orm['ets.Warehouse']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ReceiptWaybill.warehouse'
        db.delete_column('ets_receiptwaybill', 'warehouse_id')
    ...
    models = {
        ...
        'ets.receiptwaybill': {
            ...
            'warehouse': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'receipts'", 'to': "orm['ets.Warehouse']"}),
