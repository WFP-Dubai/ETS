...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WaybillAuditLogEntry.slug'
        db.add_column('ets_waybillauditlogentry', 'slug', self.gf('autoslug.fields.AutoSlugField')(default='', unique_with=(), max_length=50, populate_from=None, db_index=True), keep_default=False)
        
        for obj in orm['ets.waybillauditlogentry'].objects.all():
            obj.save() #System will create slug
        
        # Adding field 'Waybill.slug'
        db.add_column('ets_waybill', 'slug', self.gf('autoslug.fields.AutoSlugField')(default='', unique_with=(), max_length=50, populate_from=None, db_index=True), keep_default=False)
        
        for obj in orm['ets.waybill'].objects.all():
            obj.save() #System will create slug

    def backwards(self, orm):
        
        # Deleting field 'WaybillAuditLogEntry.slug'
        db.delete_column('ets_waybillauditlogentry', 'slug')

        # Deleting field 'Waybill.slug'
        db.delete_column('ets_waybill', 'slug')
    ...
    models = {
        ...
        'ets.waybill': {
            ...
            'compas': ('django.db.models.fields.CharField', [], {'default': "u'ISBX002'", 'max_length': '100'}),
