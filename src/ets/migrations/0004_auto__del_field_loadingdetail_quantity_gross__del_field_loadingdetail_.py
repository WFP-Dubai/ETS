...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'LoadingDetail.quantity_gross'
        db.delete_column('ets_loadingdetail', 'quantity_gross')

        # Deleting field 'LoadingDetail.quantity_net'
        db.delete_column('ets_loadingdetail', 'quantity_net')

        # Changing field 'LoadingDetail.number_of_units'
        db.alter_column('ets_loadingdetail', 'number_of_units', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=3))

        # Changing field 'LoadingDetail.unit_weight_gross'
        db.alter_column('ets_loadingdetail', 'unit_weight_gross', self.gf('django.db.models.fields.DecimalField')(default='50.23', max_digits=12, decimal_places=3))

        # Changing field 'LoadingDetail.unit_weight_net'
        db.alter_column('ets_loadingdetail', 'unit_weight_net', self.gf('django.db.models.fields.DecimalField')(default='50', max_digits=12, decimal_places=3))

        # Deleting field 'LoadingDetailAuditLogEntry.quantity_gross'
        db.delete_column('ets_loadingdetailauditlogentry', 'quantity_gross')

        # Deleting field 'LoadingDetailAuditLogEntry.quantity_net'
        db.delete_column('ets_loadingdetailauditlogentry', 'quantity_net')

        # Changing field 'LoadingDetailAuditLogEntry.number_of_units'
        db.alter_column('ets_loadingdetailauditlogentry', 'number_of_units', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=3))

        # Changing field 'LoadingDetailAuditLogEntry.unit_weight_gross'
        db.alter_column('ets_loadingdetailauditlogentry', 'unit_weight_gross', self.gf('django.db.models.fields.DecimalField')(default='50.34', max_digits=12, decimal_places=3))

        # Changing field 'LoadingDetailAuditLogEntry.unit_weight_net'
        db.alter_column('ets_loadingdetailauditlogentry', 'unit_weight_net', self.gf('django.db.models.fields.DecimalField')(default='50', max_digits=12, decimal_places=3))

        # Changing field 'LtiOriginal.number_of_units'
        db.alter_column(u'epic_lti', 'NUMBER_OF_UNITS', self.gf('django.db.models.fields.DecimalField')(db_column='NUMBER_OF_UNITS', decimal_places=3, max_digits=7))

        # Deleting field 'OrderItem.unit_weight_gross'
        db.delete_column('ets_orderitem', 'unit_weight_gross')

        # Deleting field 'OrderItem.comm_category_code'
        db.delete_column('ets_orderitem', 'comm_category_code')

        # Deleting field 'OrderItem.quantity_gross'
        db.delete_column('ets_orderitem', 'quantity_gross')

        # Deleting field 'OrderItem.quantity_net'
        db.delete_column('ets_orderitem', 'quantity_net')

        # Deleting field 'OrderItem.removed'
        db.delete_column('ets_orderitem', 'removed')

        # Deleting field 'OrderItem.unit_weight_net'
        db.delete_column('ets_orderitem', 'unit_weight_net')

        # Changing field 'OrderItem.number_of_units'
        db.alter_column('ets_orderitem', 'number_of_units', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=3))

        # Deleting field 'StockItem.quantity_net'
        db.delete_column('ets_stockitem', 'quantity_net')

        # Deleting field 'StockItem.quantity_gross'
        db.delete_column('ets_stockitem', 'quantity_gross')

        # Adding field 'StockItem.unit_weight_net'
        db.add_column('ets_stockitem', 'unit_weight_net', self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=12, decimal_places=3), keep_default=False)

        # Adding field 'StockItem.unit_weight_gross'
        db.add_column('ets_stockitem', 'unit_weight_gross', self.gf('django.db.models.fields.DecimalField')(default=2, max_digits=12, decimal_places=3), keep_default=False)

        # Changing field 'StockItem.number_of_units'
        db.alter_column('ets_stockitem', 'number_of_units', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=3))

        # Changing field 'EpicStock.number_of_units'
        db.alter_column(u'epic_stock', 'number_of_units', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=3))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'LoadingDetail.quantity_gross'
        raise RuntimeError("Cannot reverse this migration. 'LoadingDetail.quantity_gross' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'LoadingDetail.quantity_net'
        raise RuntimeError("Cannot reverse this migration. 'LoadingDetail.quantity_net' and its values cannot be restored.")

        # Changing field 'LoadingDetail.number_of_units'
        db.alter_column('ets_loadingdetail', 'number_of_units', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=0))

        # Changing field 'LoadingDetail.unit_weight_gross'
        db.alter_column('ets_loadingdetail', 'unit_weight_gross', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=3))

        # Changing field 'LoadingDetail.unit_weight_net'
        db.alter_column('ets_loadingdetail', 'unit_weight_net', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=3))

        # User chose to not deal with backwards NULL issues for 'LoadingDetailAuditLogEntry.quantity_gross'
        raise RuntimeError("Cannot reverse this migration. 'LoadingDetailAuditLogEntry.quantity_gross' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'LoadingDetailAuditLogEntry.quantity_net'
        raise RuntimeError("Cannot reverse this migration. 'LoadingDetailAuditLogEntry.quantity_net' and its values cannot be restored.")

        # Changing field 'LoadingDetailAuditLogEntry.number_of_units'
        db.alter_column('ets_loadingdetailauditlogentry', 'number_of_units', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=0))

        # Changing field 'LoadingDetailAuditLogEntry.unit_weight_gross'
        db.alter_column('ets_loadingdetailauditlogentry', 'unit_weight_gross', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=3))

        # Changing field 'LoadingDetailAuditLogEntry.unit_weight_net'
        db.alter_column('ets_loadingdetailauditlogentry', 'unit_weight_net', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=3))

        # Changing field 'LtiOriginal.number_of_units'
        db.alter_column(u'epic_lti', 'NUMBER_OF_UNITS', self.gf('django.db.models.fields.DecimalField')(decimal_places=0, db_column='NUMBER_OF_UNITS', max_digits=7))

        # Adding field 'OrderItem.unit_weight_gross'
        db.add_column('ets_orderitem', 'unit_weight_gross', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=3, blank=True), keep_default=False)

        # User chose to not deal with backwards NULL issues for 'OrderItem.comm_category_code'
        raise RuntimeError("Cannot reverse this migration. 'OrderItem.comm_category_code' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'OrderItem.quantity_gross'
        raise RuntimeError("Cannot reverse this migration. 'OrderItem.quantity_gross' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'OrderItem.quantity_net'
        raise RuntimeError("Cannot reverse this migration. 'OrderItem.quantity_net' and its values cannot be restored.")

        # Adding field 'OrderItem.removed'
        db.add_column('ets_orderitem', 'removed', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'OrderItem.unit_weight_net'
        db.add_column('ets_orderitem', 'unit_weight_net', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=3, blank=True), keep_default=False)

        # Changing field 'OrderItem.number_of_units'
        db.alter_column('ets_orderitem', 'number_of_units', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=0))

        # Adding field 'StockItem.quantity_net'
        db.add_column('ets_stockitem', 'quantity_net', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=3, blank=True), keep_default=False)

        # Adding field 'StockItem.quantity_gross'
        db.add_column('ets_stockitem', 'quantity_gross', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=3, blank=True), keep_default=False)

        # Deleting field 'StockItem.unit_weight_net'
        db.delete_column('ets_stockitem', 'unit_weight_net')

        # Deleting field 'StockItem.unit_weight_gross'
        db.delete_column('ets_stockitem', 'unit_weight_gross')

        # Changing field 'StockItem.number_of_units'
        db.alter_column('ets_stockitem', 'number_of_units', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'EpicStock.number_of_units'
        db.alter_column(u'epic_stock', 'number_of_units', self.gf('django.db.models.fields.IntegerField')())
