...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LoadingDetail.total_weight_net_received'
        db.add_column('ets_loadingdetail', 'total_weight_net_received', self.gf('django.db.models.fields.DecimalField')(default='0.0', max_digits=12, decimal_places=3), keep_default=False)

        # Adding field 'LoadingDetailAuditLogEntry.total_weight_net_received'
        db.add_column('ets_loadingdetailauditlogentry', 'total_weight_net_received', self.gf('django.db.models.fields.DecimalField')(default='0.0', max_digits=12, decimal_places=3), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LoadingDetail.total_weight_net_received'
        db.delete_column('ets_loadingdetail', 'total_weight_net_received')

        # Deleting field 'LoadingDetailAuditLogEntry.total_weight_net_received'
        db.delete_column('ets_loadingdetailauditlogentry', 'total_weight_net_received')
    ...
    models = {
        ...
        'ets.loadingdetail': {
            ...
            'total_weight_net_received': ('django.db.models.fields.DecimalField', [], {'max_digits': '12', 'decimal_places': '3'}),
