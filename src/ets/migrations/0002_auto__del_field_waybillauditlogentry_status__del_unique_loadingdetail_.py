...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'WaybillAuditLogEntry.status'
        db.delete_column('ets_waybillauditlogentry', 'status')

        # Deleting field 'Waybill.status'
        db.delete_column('ets_waybill', 'status')


    def backwards(self, orm):
        
        # Adding field 'WaybillAuditLogEntry.status'
        db.add_column('ets_waybillauditlogentry', 'status', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)
        ...
        # Adding field 'Waybill.status'
        db.add_column('ets_waybill', 'status', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)
    ...
    models = {
        ...
        'ets.loadingdetail': {
            'Meta': {'ordering': "('_order',)", 'object_name': 'LoadingDetail'},
