...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('ets_loadingdetailauditlogentry', 'total_weight_gross', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=3))

        # Changing field 'LoadingDetailAuditLogEntry.unit_weight_gross'
        db.alter_column('ets_loadingdetailauditlogentry', 'unit_weight_gross', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=3))

        # Changing field 'LoadingDetailAuditLogEntry.unit_weight_net'
        db.alter_column('ets_loadingdetailauditlogentry', 'unit_weight_net', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=3))

        # Changing field 'LoadingDetailAuditLogEntry.total_weight_net'
        db.alter_column('ets_loadingdetailauditlogentry', 'total_weight_net', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=3))

        # Adding field 'OrderItem.unit_weight_net'
        db.add_column('ets_orderitem', 'unit_weight_net', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=3, blank=True), keep_default=False)

        # Adding field 'OrderItem.unit_weight_gross'
        db.add_column('ets_orderitem', 'unit_weight_gross', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=3, blank=True), keep_default=False)

        # Adding field 'OrderItem.total_weight_net'
        db.add_column('ets_orderitem', 'total_weight_net', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=3, blank=True), keep_default=False)

        # Adding field 'OrderItem.total_weight_gross'
        db.add_column('ets_orderitem', 'total_weight_gross', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=3, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'OrderItem.total_weight_net'
        db.delete_column('ets_orderitem', 'total_weight_net')

        # Deleting field 'OrderItem.total_weight_gross'
        db.delete_column('ets_orderitem', 'total_weight_gross')
    ...
    models = {
        ...
        'ets.loadingdetail': {
            ...
            'total_weight_gross': ('django.db.models.fields.DecimalField', [], {'default': "'1.0'", 'max_digits': '12', 'decimal_places': '3'}),
            'total_weight_net': ('django.db.models.fields.DecimalField', [], {'default': "'1.0'", 'max_digits': '12', 'decimal_places': '3'}),
            'unit_weight_gross': ('django.db.models.fields.DecimalField', [], {'default': "'1.0'", 'max_digits': '12', 'decimal_places': '3'}),
            'unit_weight_net': ('django.db.models.fields.DecimalField', [], {'default': "'1.0'", 'max_digits': '12', 'decimal_places': '3'}),
