...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'LoadingDetail.total_weight_gross'
        db.alter_column('ets_loadingdetail', 'total_weight_gross', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=3))

        # Changing field 'LoadingDetail.unit_weight_gross'
        db.alter_column('ets_loadingdetail', 'unit_weight_gross', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=3))

        # Changing field 'LoadingDetail.total_weight_net'
        db.alter_column('ets_loadingdetail', 'total_weight_net', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=3))
