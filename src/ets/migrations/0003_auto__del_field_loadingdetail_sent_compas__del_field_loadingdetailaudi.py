...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'LoadingDetail.sent_compas'
        db.delete_column('ets_loadingdetail', 'sent_compas')

        # Deleting field 'LoadingDetailAuditLogEntry.sent_compas'
        db.delete_column('ets_loadingdetailauditlogentry', 'sent_compas')


    def backwards(self, orm):
        
        # Adding field 'LoadingDetail.sent_compas'
        db.add_column('ets_loadingdetail', 'sent_compas', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'LoadingDetailAuditLogEntry.sent_compas'
        db.add_column('ets_loadingdetailauditlogentry', 'sent_compas', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
