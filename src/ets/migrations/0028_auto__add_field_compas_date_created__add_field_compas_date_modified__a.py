...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Compas.date_created'
        db.add_column('ets_compas', 'date_created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)

        # Adding field 'Compas.date_modified'
        db.add_column('ets_compas', 'date_modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)

        # Adding field 'Compas.date_removed'
        db.add_column('ets_compas', 'date_removed', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Compas.date_created'
        db.delete_column('ets_compas', 'date_created')

        # Deleting field 'Compas.date_modified'
        db.delete_column('ets_compas', 'date_modified')

        # Deleting field 'Compas.date_removed'
        db.delete_column('ets_compas', 'date_removed')
