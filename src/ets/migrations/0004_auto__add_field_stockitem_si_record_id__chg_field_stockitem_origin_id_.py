...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_primary_key('ets_stockitem')
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'StockItem.si_record_id'
        db.delete_column('ets_stockitem', 'si_record_id')

        # Changing field 'StockItem.origin_id'
        db.alter_column('ets_stockitem', 'origin_id', self.gf('django.db.models.fields.CharField')(max_length=23, primary_key=True))

        # Adding unique constraint on 'StockItem', fields ['origin_id']
        db.create_unique('ets_stockitem', ['origin_id'])
