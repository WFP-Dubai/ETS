...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('ets_loadingdetail', 'total_weight_gross', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=5))

        # Changing field 'LoadingDetail.total_weight_net'
        db.alter_column('ets_loadingdetail', 'total_weight_net', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=5))

        # Changing field 'LoadingDetailAuditLogEntry.total_weight_gross'
        db.alter_column('ets_loadingdetailauditlogentry', 'total_weight_gross', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=5))

        # Changing field 'LoadingDetailAuditLogEntry.total_weight_net'
        db.alter_column('ets_loadingdetailauditlogentry', 'total_weight_net', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=5))


    def backwards(self, orm):
        
        # Changing field 'LoadingDetail.total_weight_gross'
        db.alter_column('ets_loadingdetail', 'total_weight_gross', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=3))

        # Changing field 'LoadingDetail.total_weight_net'
        db.alter_column('ets_loadingdetail', 'total_weight_net', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=3))
    ...
    models = {
        ...
        'ets.loadingdetail': {
            ...
            'total_weight_gross': ('django.db.models.fields.DecimalField', [], {'default': "'1.0'", 'max_digits': '12', 'decimal_places': '5'}),
            'total_weight_net': ('django.db.models.fields.DecimalField', [], {'default': "'1.0'", 'max_digits': '12', 'decimal_places': '5'}),
