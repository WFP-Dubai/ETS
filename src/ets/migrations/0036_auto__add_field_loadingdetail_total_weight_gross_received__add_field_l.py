...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LoadingDetail.total_weight_gross_received'
        db.add_column('ets_loadingdetail', 'total_weight_gross_received', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=3), keep_default=False)

        # Adding field 'LoadingDetailAuditLogEntry.total_weight_gross_received'
        db.add_column('ets_loadingdetailauditlogentry', 'total_weight_gross_received', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=3), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LoadingDetail.total_weight_gross_received'
        db.delete_column('ets_loadingdetail', 'total_weight_gross_received')

        # Deleting field 'LoadingDetailAuditLogEntry.total_weight_gross_received'
        db.delete_column('ets_loadingdetailauditlogentry', 'total_weight_gross_received')
    ...
    models = {
        ...
        'ets.lastattempt': {
            'Meta': {'ordering': "('-attempt_date',)", 'object_name': 'LastAttempt'},
            'attempt_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'compas': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'last_attempt'", 'unique': 'True', 'to': "orm['ets.Compas']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'status': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        'ets.loadingdetail': {
