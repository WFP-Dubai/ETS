...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ets_receiptwaybill', (
            ...
            ('recipient_person', self.gf('django.db.models.fields.related.ForeignKey')(related_name='recipient_waybills', to=orm['ets.CompasPerson'])),
            ('recipient_arrival_date', self.gf('django.db.models.fields.DateField')()),
            ('recipient_start_discharge_date', self.gf('django.db.models.fields.DateField')()),
            ('recipient_end_discharge_date', self.gf('django.db.models.fields.DateField')()),
            ('recipient_distance', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('recipient_remarks', self.gf('django.db.models.fields.CharField')(max_length=40, blank=True)),
            ('recipient_signed_date', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('ets', ['ReceiptWaybill'])

        # Deleting field 'WaybillAuditLogEntry.recipient_distance'
        db.delete_column('ets_waybillauditlogentry', 'recipient_distance')

        # Deleting field 'WaybillAuditLogEntry.audit_comment'
        db.delete_column('ets_waybillauditlogentry', 'audit_comment')

        # Deleting field 'WaybillAuditLogEntry.recipient_person'
        db.delete_column('ets_waybillauditlogentry', 'recipient_person_id')

        # Deleting field 'WaybillAuditLogEntry.recipient_signed_date'
        db.delete_column('ets_waybillauditlogentry', 'recipient_signed_date')

        # Deleting field 'WaybillAuditLogEntry.transport_delivery_signed_date'
        db.delete_column('ets_waybillauditlogentry', 'transport_delivery_signed_date')

        # Deleting field 'WaybillAuditLogEntry.recipient_end_discharge_date'
        db.delete_column('ets_waybillauditlogentry', 'recipient_end_discharge_date')

        # Deleting field 'WaybillAuditLogEntry.recipient_remarks'
        db.delete_column('ets_waybillauditlogentry', 'recipient_remarks')

        # Deleting field 'WaybillAuditLogEntry.recipient_start_discharge_date'
        db.delete_column('ets_waybillauditlogentry', 'recipient_start_discharge_date')

        # Deleting field 'WaybillAuditLogEntry.recipient_arrival_date'
        db.delete_column('ets_waybillauditlogentry', 'recipient_arrival_date')

        # Deleting field 'Waybill.audit_comment'
        db.delete_column('ets_waybill', 'audit_comment')

        # Deleting field 'Waybill.recipient_person'
        db.delete_column('ets_waybill', 'recipient_person_id')

        # Deleting field 'Waybill.transport_delivery_signed_date'
        db.delete_column('ets_waybill', 'transport_delivery_signed_date')

        # Deleting field 'Waybill.recipient_signed_date'
        db.delete_column('ets_waybill', 'recipient_signed_date')

        # Deleting field 'Waybill.recipient_end_discharge_date'
        db.delete_column('ets_waybill', 'recipient_end_discharge_date')

        # Deleting field 'Waybill.recipient_remarks'
        db.delete_column('ets_waybill', 'recipient_remarks')

        # Deleting field 'Waybill.recipient_start_discharge_date'
        db.delete_column('ets_waybill', 'recipient_start_discharge_date')

        # Deleting field 'Waybill.recipient_arrival_date'
        db.delete_column('ets_waybill', 'recipient_arrival_date')

        # Deleting field 'Waybill.recipient_distance'
        db.delete_column('ets_waybill', 'recipient_distance')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'WaybillAuditLogEntry.recipient_distance'
        db.add_column('ets_waybillauditlogentry', 'recipient_distance', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'WaybillAuditLogEntry.audit_comment'
        db.add_column('ets_waybillauditlogentry', 'audit_comment', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'WaybillAuditLogEntry.recipient_person'
        db.add_column('ets_waybillauditlogentry', 'recipient_person', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_auditlog_recipient_waybills', null=True, to=orm['ets.CompasPerson'], blank=True), keep_default=False)

        # Adding field 'WaybillAuditLogEntry.recipient_signed_date'
        db.add_column('ets_waybillauditlogentry', 'recipient_signed_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'WaybillAuditLogEntry.transport_delivery_signed_date'
        db.add_column('ets_waybillauditlogentry', 'transport_delivery_signed_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'WaybillAuditLogEntry.recipient_end_discharge_date'
        db.add_column('ets_waybillauditlogentry', 'recipient_end_discharge_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'WaybillAuditLogEntry.recipient_remarks'
        db.add_column('ets_waybillauditlogentry', 'recipient_remarks', self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True), keep_default=False)

        # Adding field 'WaybillAuditLogEntry.recipient_start_discharge_date'
        db.add_column('ets_waybillauditlogentry', 'recipient_start_discharge_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'WaybillAuditLogEntry.recipient_arrival_date'
        db.add_column('ets_waybillauditlogentry', 'recipient_arrival_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'Waybill.audit_comment'
        db.add_column('ets_waybill', 'audit_comment', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Waybill.recipient_person'
        db.add_column('ets_waybill', 'recipient_person', self.gf('django.db.models.fields.related.ForeignKey')(related_name='recipient_waybills', null=True, to=orm['ets.CompasPerson'], blank=True), keep_default=False)

        # Adding field 'Waybill.transport_delivery_signed_date'
        db.add_column('ets_waybill', 'transport_delivery_signed_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Waybill.recipient_signed_date'
        db.add_column('ets_waybill', 'recipient_signed_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Waybill.recipient_end_discharge_date'
        db.add_column('ets_waybill', 'recipient_end_discharge_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'Waybill.recipient_remarks'
        db.add_column('ets_waybill', 'recipient_remarks', self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True), keep_default=False)

        # Adding field 'Waybill.recipient_start_discharge_date'
        db.add_column('ets_waybill', 'recipient_start_discharge_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'Waybill.recipient_arrival_date'
        db.add_column('ets_waybill', 'recipient_arrival_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'Waybill.recipient_distance'
        db.add_column('ets_waybill', 'recipient_distance', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)
