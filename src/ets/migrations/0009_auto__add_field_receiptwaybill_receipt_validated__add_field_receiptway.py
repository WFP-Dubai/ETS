...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'WaybillAuditLogEntry.receipt_validated'
        db.delete_column('ets_waybillauditlogentry', 'receipt_validated')

        # Deleting field 'WaybillAuditLogEntry.rec_sent_compas'
        db.delete_column('ets_waybillauditlogentry', 'rec_sent_compas')

        # Deleting field 'Waybill.receipt_validated'
        db.delete_column('ets_waybill', 'receipt_validated')

        # Deleting field 'Waybill.rec_sent_compas'
        db.delete_column('ets_waybill', 'rec_sent_compas')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'WaybillAuditLogEntry.receipt_validated'
        db.add_column('ets_waybillauditlogentry', 'receipt_validated', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'WaybillAuditLogEntry.rec_sent_compas'
        db.add_column('ets_waybillauditlogentry', 'rec_sent_compas', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Waybill.receipt_validated'
        db.add_column('ets_waybill', 'receipt_validated', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Waybill.rec_sent_compas'
        db.add_column('ets_waybill', 'rec_sent_compas', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
