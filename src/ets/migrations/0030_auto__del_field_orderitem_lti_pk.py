...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'OrderItem.lti_pk'
        db.delete_column('ets_orderitem', 'lti_pk')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'OrderItem.lti_pk'
        raise RuntimeError("Cannot reverse this migration. 'OrderItem.lti_pk' and its values cannot be restored.")
