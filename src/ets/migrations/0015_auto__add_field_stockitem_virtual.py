...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StockItem.virtual'
        db.add_column('ets_stockitem', 'virtual', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'StockItem.virtual'
        db.delete_column('ets_stockitem', 'virtual')
