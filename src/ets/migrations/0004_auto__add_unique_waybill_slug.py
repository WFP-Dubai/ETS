...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Waybill', fields ['slug']
        db.create_unique('ets_waybill', ['slug'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Waybill', fields ['slug']
        db.delete_unique('ets_waybill', ['slug'])
