...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'WaybillAuditLogEntry.invalidated'
        db.delete_column('ets_waybillauditlogentry', 'invalidated')

        # Deleting field 'LoadingDetail.units_damaged_type'
        db.delete_column('ets_loadingdetail', 'units_damaged_type_id')

        # Deleting field 'LoadingDetail.units_lost_type'
        db.delete_column('ets_loadingdetail', 'units_lost_type_id')

        # Deleting field 'LoadingDetailAuditLogEntry.units_damaged_type'
        db.delete_column('ets_loadingdetailauditlogentry', 'units_damaged_type_id')

        # Deleting field 'LoadingDetailAuditLogEntry.units_lost_type'
        db.delete_column('ets_loadingdetailauditlogentry', 'units_lost_type_id')

        # Deleting field 'Waybill.invalidated'
        db.delete_column('ets_waybill', 'invalidated')


    def backwards(self, orm):
        
        # Adding field 'WaybillAuditLogEntry.invalidated'
        db.add_column('ets_waybillauditlogentry', 'invalidated', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'LoadingDetail.units_damaged_type'
        db.add_column('ets_loadingdetail', 'units_damaged_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='damage_type', null=True, to=orm['ets.LossDamageType'], blank=True), keep_default=False)

        # Adding field 'LoadingDetail.units_lost_type'
        db.add_column('ets_loadingdetail', 'units_lost_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='loss_type', null=True, to=orm['ets.LossDamageType'], blank=True), keep_default=False)

        # Adding field 'LoadingDetailAuditLogEntry.units_damaged_type'
        db.add_column('ets_loadingdetailauditlogentry', 'units_damaged_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_auditlog_damage_type', null=True, to=orm['ets.LossDamageType'], blank=True), keep_default=False)

        # Adding field 'LoadingDetailAuditLogEntry.units_lost_type'
        db.add_column('ets_loadingdetailauditlogentry', 'units_lost_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_auditlog_loss_type', null=True, to=orm['ets.LossDamageType'], blank=True), keep_default=False)

        # Adding field 'Waybill.invalidated'
        db.add_column('ets_waybill', 'invalidated', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
