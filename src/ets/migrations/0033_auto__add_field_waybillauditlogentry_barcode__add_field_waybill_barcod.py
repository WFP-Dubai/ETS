...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WaybillAuditLogEntry.barcode'
        db.add_column('ets_waybillauditlogentry', 'barcode', self.gf('sorl.thumbnail.fields.ImageField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Waybill.barcode'
        db.add_column('ets_waybill', 'barcode', self.gf('sorl.thumbnail.fields.ImageField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WaybillAuditLogEntry.barcode'
        db.delete_column('ets_waybillauditlogentry', 'barcode')

        # Deleting field 'Waybill.barcode'
        db.delete_column('ets_waybill', 'barcode')
