...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field warehouses on 'Person'
        db.create_table('ets_person_warehouses', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('person', models.ForeignKey(orm['ets.person'], null=False)),
            ('warehouse', models.ForeignKey(orm['ets.warehouse'], null=False))
        ))
        db.create_unique('ets_person_warehouses', ['person_id', 'warehouse_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field warehouses on 'Person'
        db.delete_table('ets_person_warehouses')
