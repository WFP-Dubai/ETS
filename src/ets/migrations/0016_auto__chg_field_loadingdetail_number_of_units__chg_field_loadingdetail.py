...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('ets_loadingdetail', 'number_of_units', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'LoadingDetailAuditLogEntry.number_of_units'
        db.alter_column('ets_loadingdetailauditlogentry', 'number_of_units', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'OrderItem.number_of_units'
        db.alter_column('ets_orderitem', 'number_of_units', self.gf('django.db.models.fields.IntegerField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'OrderItem.number_of_units'
        db.alter_column('ets_orderitem', 'number_of_units', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=3))
