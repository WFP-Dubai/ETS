...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OrderItem.project_number'
        db.add_column('ets_orderitem', 'project_number', self.gf('django.db.models.fields.CharField')(default='', max_length=24, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OrderItem.project_number'
        db.delete_column('ets_orderitem', 'project_number')
