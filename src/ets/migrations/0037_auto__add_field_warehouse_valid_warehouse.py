...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Warehouse.valid_warehouse'
        db.add_column('ets_warehouse', 'valid_warehouse',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Warehouse.valid_warehouse'
        db.delete_column('ets_warehouse', 'valid_warehouse')
