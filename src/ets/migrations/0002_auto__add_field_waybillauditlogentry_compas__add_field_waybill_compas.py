...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WaybillAuditLogEntry.compas'
        db.add_column('ets_waybillauditlogentry', 'compas', self.gf('django.db.models.fields.CharField')(default=u'ISBX002', max_length=100), keep_default=False)

        # Adding field 'Waybill.compas'
        db.add_column('ets_waybill', 'compas', self.gf('django.db.models.fields.CharField')(default=u'ISBX002', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WaybillAuditLogEntry.compas'
        db.delete_column('ets_waybillauditlogentry', 'compas')

        # Deleting field 'Waybill.compas'
        db.delete_column('ets_waybill', 'compas')
