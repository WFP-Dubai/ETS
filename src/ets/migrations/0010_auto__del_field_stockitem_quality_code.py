...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'StockItem.quality_code'
        db.delete_column('ets_stockitem', 'quality_code')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'StockItem.quality_code'
        raise RuntimeError("Cannot reverse this migration. 'StockItem.quality_code' and its values cannot be restored.")
