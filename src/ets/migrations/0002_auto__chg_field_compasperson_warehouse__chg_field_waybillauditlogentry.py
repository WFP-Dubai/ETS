...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CompasPerson.warehouse'
        db.alter_column(u'epic_persons', 'org_unit_code', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ets.Warehouse'], db_column='org_unit_code'))

        # Adding index on 'CompasPerson', fields ['warehouse']
        db.create_index(u'epic_persons', ['org_unit_code'])

        # Changing field 'WaybillAuditLogEntry.recipient_remarks'
        db.alter_column('ets_waybillauditlogentry', 'recipient_remarks', self.gf('django.db.models.fields.CharField')(max_length=40))

        # Changing field 'Waybill.recipient_remarks'
        db.alter_column('ets_waybill', 'recipient_remarks', self.gf('django.db.models.fields.CharField')(max_length=40))


    def backwards(self, orm):
        
        # Removing index on 'CompasPerson', fields ['warehouse']
        db.delete_index(u'epic_persons', ['org_unit_code'])

        # Changing field 'CompasPerson.warehouse'
        db.alter_column(u'epic_persons', 'org_unit_code', self.gf('django.db.models.fields.CharField')(max_length=13, db_column='org_unit_code'))

        # Changing field 'WaybillAuditLogEntry.recipient_remarks'
        db.alter_column('ets_waybillauditlogentry', 'recipient_remarks', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Waybill.recipient_remarks'
        db.alter_column('ets_waybill', 'recipient_remarks', self.gf('django.db.models.fields.TextField')())
