...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompasLogger.user'
        db.add_column('ets_compaslogger', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='compas_loggers', null=True, to=orm['auth.User']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'CompasLogger.user'
        db.delete_column('ets_compaslogger', 'user_id')
    ...
    models = {
        ...
        'ets.compaslogger': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'compas_loggers'", 'null': 'True', 'to': "orm['auth.User']"}),
