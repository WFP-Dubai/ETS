...
class EpicPersonsTemp(models.Model):
    person_pk = models.CharField(max_length=20, blank=True)
    org_unit_code = models.CharField(max_length=13)
    ...
    class Meta:
        db_table = u'epic_persons_temp'

class EpicStockTemp(models.Model):
    wh_pk = models.CharField(max_length=90, blank=True)
    ...
    quantity_gross = models.DecimalField(null=True, max_digits=0, decimal_places=-127, blank=True)
    number_of_units = models.IntegerField()
    allocation_code = models.CharField(max_length=10)
    class Meta:
        db_table = u'epic_stock_temp'
